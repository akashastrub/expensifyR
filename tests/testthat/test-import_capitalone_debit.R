test_that("import_capitalone_debit function outputs USD values", {

  path <- testthat::test_path("fixtures", "capitalone_debit_usd_test.csv")
  df_cdm <- expensifyR::import_capitalone_debit(path, "usd")
