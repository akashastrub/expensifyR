test_that("import_boa_credit function outputs USD values", {

  path <- testthat::test_path("fixtures", "boa_credit_usd_test.csv")
  df_cdm <- expensifyR::import_boa_credit(path, "usd")
