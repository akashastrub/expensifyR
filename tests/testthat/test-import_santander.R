test_that("import_santander function outputs USD values", {

  path <- testthat::test_path("fixtures", "santander_usd_test.csv")
  df_cdm <- expensifyR::import_santander(path, "usd")
